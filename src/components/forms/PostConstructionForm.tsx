    ...
    <form onSubmit={handleSubmit} className="animate-fade-in max-w-2xl mx-auto bg-card rounded-lg border p-6">
      <div className="bg-card rounded-lg border p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-display text-lg uppercase tracking-wide">Post-Construction Cleaning</h3>
            <p className="text-sm text-muted-foreground">Deep cleaning after renovation or construction</p>
          </div>
        </div>
        <p className="text-sm text-muted-foreground">
          Post-construction cleaning requires special equipment and techniques. We'll assess 
          your property and provide a custom quote based on the scope of work needed.
        </p>
      </div>
